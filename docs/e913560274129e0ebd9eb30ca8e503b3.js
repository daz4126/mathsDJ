    ...
    !state.fullScreen ? (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          'li',
          null,
          'Press the MIX button to generage a new set of questions.'
        ),
        (0, _hyperapp.h)(
          'li',
          null,
...
},{"./css/index.scss":3,"hyperapp":12,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],16:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '55137' + '/');
