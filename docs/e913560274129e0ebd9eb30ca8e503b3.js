...
},{"hyperapp":12,"./topics.js":10,"./utils.js":8}],10:[function(require,module,exports) {
'use strict';
...
},{"./components.js":9}],8:[function(require,module,exports) {
'use strict';
...
var view = function view(state, actions) {
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        ...
        Object.entries(_topics2.default).map(function (_ref) {
          ...
          return (0, _hyperapp.h)(
            'button',
            { 'class': 'topic pure-button', onclick: function onclick() {
    ...
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        'button',
        { 'class': 'pure-button', onclick: actions.mix },
        (0, _hyperapp.h)('i', { 'class': 'fa fa-sync-alt' }),
        'MIX'
      ),
      (0, _hyperapp.h)(
        'button',
        { 'class': 'pure-button', onclick: actions.toggleShowAnswer },
...
},{"./css/index.scss":3,"hyperapp":12,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],13:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '52094' + '/');
