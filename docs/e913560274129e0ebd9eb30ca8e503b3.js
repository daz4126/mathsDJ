    ...
    (0, _hyperapp.h)(
      ...
      state.topic ? (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          'p',
          null,
          'Maths DJ is the easiest way to create questions for tests and worksheets'
        ),
        (0, _hyperapp.h)(
          'h2',
          null,
...
},{"./css/index.scss":3,"hyperapp":12,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],17:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '51045' + '/');
