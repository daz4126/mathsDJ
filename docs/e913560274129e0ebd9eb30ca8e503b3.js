    ...
    (0, _hyperapp.h)(
      ...
      state.topic ? (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          'p',
          null,
          'Click on the MIX button to generate a new set of questions and click on Show Answers to see if you got them right.'
        )
      )
    ),
    !state.fullScreen ? (0, _hyperapp.h)(
...
},{"./css/index.scss":3,"hyperapp":12,"./js/actions.js":4,"./js/state.js":6,"./js/view.js":5}],16:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '54039' + '/');
