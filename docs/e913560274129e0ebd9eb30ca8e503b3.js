...
},{"_css_loader":12}],14:[function(require,module,exports) {
"use strict";
...
var Multiplication = exports.Multiplication = function Multiplication(_ref2) {
  ...
  return (0, _hyperapp.h)(
    'li',
    { key: key },
    numbers[0] / Math.pow(10, x - 3),
    ' \xD7 ',
    numbers[1] / Math.pow(10, y - 3),
    ' ',
    showAnswer ? (0, _hyperapp.h)(
      'span',
      { 'class': 'answer' },
      '= ',
      numbers[0] * numbers[1] / Math.pow(10, x + y - 6)
    ) : null
  );
};
...
var Brackets = exports.Brackets = function Brackets(_ref6) {
  ...
  return (0, _hyperapp.h)(
    ...
    showAnswer ? (0, _hyperapp.h)(
      ...
      { 'class': 'answer' },
      ' = ',
      (0, _utils.coeff)((numbers[0] + 1) * numbers[1]),
      (0, _hyperapp.h)(
        'i',
        null,
        'x'
...
},{"hyperapp":14,"./topics.js":11,"./utils.js":9}],11:[function(require,module,exports) {
'use strict';
...
exports.plusorminus = exports.coeff = exports.uuid = exports.mix = undefined;
    ...
    (0, _hyperapp.h)(
      ...
      state.topic ? (0, _hyperapp.h)(
        ...
        (0, _hyperapp.h)(
          'p',
          null,
          'Maths DJ is the easiest way to generate lots of questions to answer.'
        ),
        (0, _hyperapp.h)(
          'h2',
          null,
        ...
        (0, _hyperapp.h)(
          'p',
          null,
          'Click on the MIX button to generate new questions and click on Show Answers to see if you got them right.'
        )
      )
    ),
    !state.fullScreen ? (0, _hyperapp.h)(
...
},{"hyperapp":14,"./components.js":10,"./topics.js":11}],2:[function(require,module,exports) {
'use strict';
...
},{"./css/index.scss":3,"hyperapp":14,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],17:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '52511' + '/');
