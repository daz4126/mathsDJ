...
exports.Percent = exports.Equation = exports.Division = exports.Multiplication = exports.Question = undefined;
...
},{"hyperapp":13,"./topics.js":10}],10:[function(require,module,exports) {
'use strict';
...
},{"./components.js":8}],9:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uuid = exports.mix = undefined;
...
var mix = exports.mix = function mix(topic) {
...
var actions = {
  mix: function mix(topic) {
    return function (state) {
      return {
        questions: (0, _utils.mix)(topic)
      };
    };
  },
...
var view = function view(state, actions) {
  return (0, _hyperapp.h)(
    ...
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        'button',
        { 'class': 'topic pure-button pure-button-primary', onclick: function onclick() {
      ...
      (0, _hyperapp.h)(
        'button',
        { 'class': 'topic pure-button pure-button-primary', onclick: function onclick() {
            return actions.changeTopic('eqn');
          } },
        'Equations'
      ),
      (0, _hyperapp.h)(
        'button',
        { 'class': 'topic pure-button pure-button-primary', onclick: function onclick() {
            return actions.changeTopic('percent');
          } },
        'Percentages'
      )
    ),
    (0, _hyperapp.h)(
      ...
      (0, _hyperapp.h)(
        ...
        { 'class': 'pure-button pure-button-primary', onclick: function onclick() {
            return actions.mix(state.topic);
          } },
      ...
      (0, _hyperapp.h)(
        ...
        state.questions.map(function (numbers, i) {
          return (0, _hyperapp.h)(_components.Question, { topic: state.topic, numbers: numbers, showAnswer: state.showAnswer, key: i });
        })
      )
    ),
    (0, _hyperapp.h)(
...
},{"hyperapp":13,"./components.js":8,"./topics.js":10}],2:[function(require,module,exports) {
'use strict';
...
},{"./css/index.scss":3,"hyperapp":13,"./js/actions.js":4,"./js/state.js":5,"./js/view.js":6}],14:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '52643' + '/');
